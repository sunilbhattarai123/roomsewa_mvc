                ...
                for ($i = 1; $i <= $rowcount; $i++) {
                  ...
                  if ($i == 1) {
                    ...
                    <div class="item active">
                      <img class="d-block img-fluid" src="<?php echo $photo ?>" alt="First slide" width="100%"
...
<form action="update.php" method="post">
  ...
  <button type="submit" class="btn btn-success btn-info" name="update"  style="width: 100%">Update Property</button>
</form>
<form action="delete.php" method="post">
  <input type="hidden" name="property_id" value="<?php echo $property_id?>">
  <button type="submit" class="btn btn-danger btn-info" name="delete_property"  style="width: 100%">Delete  Property</button>
</form>
